%%% ====================================================================
%%% amssym.tex + txfonts (JM+SW) 09.03.2001. Public domain
...
\expandafter\chardef\csname pre amsqtx.tex at\endcsname=\the\catcode`\@
%%  Set the catcode to 11 for use in private control sequence names.
\catcode`\@=11
%%  Load amsqtx.def if necessary: If \newsymbol is undefined, do nothing
...
\catcode`\@=\csname pre amsqtx.tex at\endcsname
