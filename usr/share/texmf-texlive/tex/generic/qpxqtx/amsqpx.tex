%%% ====================================================================
%%% amssym.tex + pxfonts (JM+SW) 09.03.2001. Public domain
%%% Macros borowed from amssym.tex ver. 2.2b by American Mathematical Society
%%% This file must not be changed. However, if you do make changes,
%%% you first rename it to some other name.
%%% ====================================================================
%%  We store the catcode of the @ in the csname.
\expandafter\chardef\csname pre amsqpx.tex at\endcsname=\the\catcode`\@
%%  Set the catcode to 11 for use in private control sequence names.
\catcode`\@=11
%%  Load amsqpx.def if necessary: If \newsymbol is undefined, do nothing
...
\catcode`\@=\csname pre amsqpx.tex at\endcsname
